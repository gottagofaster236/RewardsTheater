...
2. Download the `RewardsTheater-windows-x64.zip` file from [this link](https://github.com/gottagofaster236/RewardsTheater/releases/latest).
   Unpack it into your OBS installation folder (usually `C:\Program Files\obs-studio`).
