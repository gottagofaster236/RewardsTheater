...
2. Завантаж `RewardsTheater-windows-x64.zip` за [цим посиланням](https://github.com/gottagofaster236/RewardsTheater/releases/latest).
   Розпакуй його в папку, куди встановлено OBS (зазвичай `C:\Program Files\obs-studio`).
...
2. **Інсталятор не має електронного підпису, бо підпис від Apple коштує $100 на рік.**
...
5. Якщо ти хочеш чути відео, коли чат його замовляє, то знайди джерело в «Мікшер аудіо», натисни на нього правою кнопкою миші, вибери «Розширені властивості аудіо» і вибери «Прослуховування та вивід» у стовбці «Прослуховування звуку».
   Щоб відеоі з'явилося в цьому меню, зроби його видимим і розпочни відтворення.
